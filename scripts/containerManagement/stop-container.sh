...
echo "🛑 Stopping Admin UI Service containers..."
print_separator "="
...
kubectl scale deployment admin-ui-service --replicas=0 -n "$NAMESPACE"
...
print_separator "="
print_status "ok" "Admin UI Service containers stopped"
