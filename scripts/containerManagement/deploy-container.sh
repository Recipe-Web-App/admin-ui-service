...
print_separator "="
echo -e "${CYAN}🔗 Setting up /etc/hosts for admin-ui.local...${NC}"
print_separator "-"
...
print_separator "="
echo -e "${GREEN}🌍 You can now access your app at: http://admin-ui.local${NC}"
...
echo "  Health Check: http://admin-ui.local/api/health"
echo "  Readiness Check: http://admin-ui.local/api/health/ready"
echo "  Liveness Check: http://admin-ui.local/api/health/live"
print_separator "="
