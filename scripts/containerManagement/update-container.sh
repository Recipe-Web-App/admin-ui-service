...
echo "🔄 Updating Admin UI Service..."
print_separator "="
...
print_separator
echo -e "${CYAN}🟢 Rebuilding Angular Docker image: ${FULL_IMAGE_NAME}${NC}"
...
kubectl rollout status deployment/admin-ui-service -n "$NAMESPACE" --timeout=120s
...
print_separator "="
print_status "ok" "Admin UI Service updated successfully!"
echo -e "${CYAN}🌍 Access at: http://admin-ui.local${NC}"
